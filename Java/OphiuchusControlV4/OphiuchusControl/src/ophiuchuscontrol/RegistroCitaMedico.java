...
public final class RegistroCitaMedico extends javax.swing.JFrame {
    private String idUser;
    private Utilidades util;
    private VistaCitas Antecesor;
    
    public RegistroCitaMedico(String idUser, VistaCitas Antecesor) {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        cbbday.setBounds(110, 230, 50, 30);
        ...
        cbbmonth.setBounds(170, 230, 50, 30);
        ...
        cbbyear.setBounds(230, 230, 70, 30);
        ...
        jLabel3.setBounds(20, 50, 170, 40);

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Año");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(240, 210, 34, 15);

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Hora:");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(40, 210, 34, 15);

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Mes");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(170, 210, 34, 15);

        jLabel7.setText("Paciente a citar:");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(30, 100, 180, 20);
        ...
        calendario.setBounds(360, 90, 380, 210);

        jLabel8.setText("Verifique su fecha aquí:");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(370, 50, 200, 40);

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("Día");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(110, 210, 34, 15);
        ...
        cbbhour.setBounds(40, 230, 60, 30);
    ...
    private void BtnCancActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCancActionPerformed
        ...
        Conexion conex = new Conexion();
        if(!conex.ExisteEnBD("select * from Cita where FechaHora='"+fecha+"' and CedulaProfesional='"+idUser+"';")){
            if(conex.EjecutarActualizacion("insert into Cita values('"+fecha+"','"+cmbPaciente.getSelectedItem().toString()+"','"+idUser+"',NULL,NULL);")){
